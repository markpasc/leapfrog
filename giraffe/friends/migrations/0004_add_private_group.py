...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        group = orm.Group.objects.create(display_name='Private (Draft)', tag='private')
        # We might add "me" to it, but "I" am implicitly in all groups.


    def backwards(self, orm):
        orm.Group.objects.get(tag='private').delete()
