...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Group.tag'
        db.alter_column('friends_group', 'tag', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))


    def backwards(self, orm):
        
        # Changing field 'Group.tag'
        db.alter_column('friends_group', 'tag', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))
