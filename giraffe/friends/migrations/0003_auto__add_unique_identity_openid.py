...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Identity', fields ['openid']
        db.create_unique('friends_identity', ['openid'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Identity', fields ['openid']
        db.delete_unique('friends_identity', ['openid'])
