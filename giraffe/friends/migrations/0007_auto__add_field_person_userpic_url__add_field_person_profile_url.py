...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.userpic_url'
        db.add_column('friends_person', 'userpic_url', self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True), keep_default=False)

        # Adding field 'Person.profile_url'
        db.add_column('friends_person', 'profile_url', self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.userpic_url'
        db.delete_column('friends_person', 'userpic_url')

        # Deleting field 'Person.profile_url'
        db.delete_column('friends_person', 'profile_url')
    ...
    models = {
        ...
        'friends.identity': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'openid': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '300'}),
