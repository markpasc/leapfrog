...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('friends_identity', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['friends.Person'])),
            ('openid', self.gf('django.db.models.fields.CharField')(max_length=300)),
        ))
        db.send_create_signal('friends', ['Identity'])


    def backwards(self, orm):
        
        # Deleting model 'Identity'
        db.delete_table('friends_identity')
    ...
    models = {
        ...
        'friends.identity': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'openid': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
