...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Asset.published'
        db.add_column('publisher_asset', 'published', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Asset.published'
        db.delete_column('publisher_asset', 'published')
    ...
    models = {
        ...
        'publisher.asset': {
            ...
            'atom_id': ('django.db.models.fields.CharField', [], {'default': "u'tag:example.com,2010:3270374045903229104'", 'unique': 'True', 'max_length': '200', 'blank': 'True'}),
