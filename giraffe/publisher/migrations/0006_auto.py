...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field private_to on 'Asset'
        db.create_table('publisher_asset_private_to', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('asset', models.ForeignKey(orm['publisher.asset'], null=False)),
            ('group', models.ForeignKey(orm['friends.group'], null=False))
        ))
        db.create_unique('publisher_asset_private_to', ['asset_id', 'group_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field private_to on 'Asset'
        db.delete_table('publisher_asset_private_to')
