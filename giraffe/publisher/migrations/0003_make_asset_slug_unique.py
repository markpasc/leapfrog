...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.create_unique('publisher_asset', ['slug'])


    def backwards(self, orm):
        db.delete_unique('publisher_asset', ['slug'])
    ...
    models = {
        ...
        'publisher.asset': {
            ...
            'atom_id': ('django.db.models.fields.CharField', [], {'default': "u'tag:example.com,2010:1661138065740929676'", 'unique': 'True', 'max_length': '200', 'blank': 'True'}),
