...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subscription.mode'
        db.add_column('aggregator_subscription', 'mode', self.gf('django.db.models.fields.CharField')(default='poll', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Subscription.mode'
        db.delete_column('aggregator_subscription', 'mode')
