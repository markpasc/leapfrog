...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserStream.time'
        db.alter_column('rhino_userstream', 'time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Person.user'
        db.alter_column('rhino_person', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True, blank=True))

        # Adding unique constraint on 'Person', fields ['user']
        db.create_unique('rhino_person', ['user_id'])

        # Changing field 'Account.status_background_tile'
        db.alter_column('rhino_account', 'status_background_tile', self.gf('django.db.models.fields.BooleanField')(blank=True))


    def backwards(self, orm):
        
        # Changing field 'UserStream.time'
        db.alter_column('rhino_userstream', 'time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))

        # Changing field 'Person.user'
        db.alter_column('rhino_person', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True))

        # Removing unique constraint on 'Person', fields ['user']
        db.delete_unique('rhino_person', ['user_id'])

        # Changing field 'Account.status_background_tile'
        db.alter_column('rhino_account', 'status_background_tile', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'rhino.account': {
            ...
            'status_background_tile': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'})
        },
        'rhino.media': {
