...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('rhino_object', 'object_type')

        # Deleting field 'Object.name'
        db.delete_column('rhino_object', 'name')
        ...
        # Deleting field 'Object.summary'
        db.delete_column('rhino_object', 'summary')

        # Adding field 'Object.title'
        db.add_column('rhino_object', 'title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Object.body'
        db.add_column('rhino_object', 'body', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Object.image'
        db.add_column('rhino_object', 'image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rhino.Media'], null=True, blank=True), keep_default=False)

        # Adding field 'Object.render_mode'
        db.add_column('rhino_object', 'render_mode', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('rhino_object', 'object_type', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True), keep_default=False)

        # Adding field 'Object.name'
        db.add_column('rhino_object', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Object.author'
        db.add_column('rhino_object', 'author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='authored', null=True, to=orm['rhino.Object'], blank=True), keep_default=False)
        ...
        # Adding field 'Object.summary'
        db.add_column('rhino_object', 'summary', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Deleting field 'Object.title'
        db.delete_column('rhino_object', 'title')

        # Deleting field 'Object.body'
        db.delete_column('rhino_object', 'body')

        # Deleting field 'Object.image'
        db.delete_column('rhino_object', 'image_id')

        # Deleting field 'Object.render_mode'
        db.delete_column('rhino_object', 'render_mode')
    ...
    models = {
        ...
        'rhino.object': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rhino.Media']", 'null': 'True', 'blank': 'True'}),
