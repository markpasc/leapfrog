...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Object.public'
        db.add_column('rhino_object', 'public', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Object.public'
        db.delete_column('rhino_object', 'public')
