...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('rhino_account', 'name')

        # Adding field 'Account.ident'
        db.add_column('rhino_account', 'ident', self.gf('django.db.models.fields.CharField')(default='someident', max_length=100), keep_default=False)

        # Adding field 'Account.display_name'
        db.add_column('rhino_account', 'display_name', self.gf('django.db.models.fields.CharField')(default='somename', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Account.name'
        db.add_column('rhino_account', 'name', self.gf('django.db.models.fields.CharField')(default='somename', max_length=100), keep_default=False)

        # Deleting field 'Account.ident'
        db.delete_column('rhino_account', 'ident')

        # Deleting field 'Account.display_name'
        db.delete_column('rhino_account', 'display_name')
