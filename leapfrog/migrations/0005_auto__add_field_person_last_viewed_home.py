...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.last_viewed_home'
        db.add_column('leapfrog_person', 'last_viewed_home', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.last_viewed_home'
        db.delete_column('leapfrog_person', 'last_viewed_home')
    ...
    models = {
        ...
        'leapfrog.person': {
            ...
            'display_name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_viewed_home': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
