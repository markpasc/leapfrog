...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('rhino_usersetting', (
        ...
        db.send_create_signal('rhino', ['UserSetting'])

        # Adding unique constraint on 'UserSetting', fields ['user', 'key']
        db.create_unique('rhino_usersetting', ['user_id', 'key'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'UserSetting', fields ['user', 'key']
        db.delete_unique('rhino_usersetting', ['user_id', 'key'])

        # Deleting model 'UserSetting'
        db.delete_table('rhino_usersetting')
