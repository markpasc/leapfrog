...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Object.content'
        db.delete_column('rhino_object', 'content')

        # Changing field 'Object.body'
        db.alter_column('rhino_object', 'body', self.gf('django.db.models.fields.TextField')(blank=True))


    def backwards(self, orm):
        
        # Adding field 'Object.content'
        db.add_column('rhino_object', 'content', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Changing field 'Object.body'
        db.alter_column('rhino_object', 'body', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))
