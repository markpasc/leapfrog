...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.permalink_url'
        db.add_column('rhino_person', 'permalink_url', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.permalink_url'
        db.delete_column('rhino_person', 'permalink_url')
