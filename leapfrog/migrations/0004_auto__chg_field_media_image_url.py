...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Media.image_url'
        db.alter_column('leapfrog_media', 'image_url', self.gf('django.db.models.fields.CharField')(max_length=300))


    def backwards(self, orm):
        
        # Changing field 'Media.image_url'
        db.alter_column('leapfrog_media', 'image_url', self.gf('django.db.models.fields.CharField')(max_length=255))
