...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Account.status_background_image_url'
        db.alter_column('leapfrog_account', 'status_background_image_url', self.gf('django.db.models.fields.CharField')(max_length=150))


    def backwards(self, orm):
        
        # Changing field 'Account.status_background_image_url'
        db.alter_column('leapfrog_account', 'status_background_image_url', self.gf('django.db.models.fields.CharField')(max_length=100))
