...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Media.sfw'
        db.add_column('leapfrog_media', 'sfw', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Media.sfw'
        db.delete_column('leapfrog_media', 'sfw')
