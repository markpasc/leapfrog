...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.status_background_color'
        db.add_column('rhino_account', 'status_background_color', self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True), keep_default=False)

        # Adding field 'Account.status_background_image_url'
        db.add_column('rhino_account', 'status_background_image_url', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Account.status_background_tile'
        db.add_column('rhino_account', 'status_background_tile', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Account.status_background_color'
        db.delete_column('rhino_account', 'status_background_color')

        # Deleting field 'Account.status_background_image_url'
        db.delete_column('rhino_account', 'status_background_image_url')

        # Deleting field 'Account.status_background_tile'
        db.delete_column('rhino_account', 'status_background_tile')
