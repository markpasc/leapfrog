...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.avatar_source'
        db.add_column('leapfrog_person', 'avatar_source', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.avatar_source'
        db.delete_column('leapfrog_person', 'avatar_source')
